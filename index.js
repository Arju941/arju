...
const showData=(values)=>{
    ...
    for(const value of values ){
        ...
        div.innerHTML=`
         ...
         <div class="p-5 mt-8 rounded-md bg-[#f3d4a8] shadow-slate-300  h-80">
     ...
     <div class="font-semibold text-lg gap-2 ">
      ...
      <div class="flex ">
        ...
        <div>
          ...
          <button onclick='add(${JSON.stringify(value)})' class="font-semibold px-4 py-1 ml-20 bg-slate-400 rounded-md mt-5" >select</button>
...
const add=(btn)=>{
 ...
 const li=document.createElement("li")
  li.innerHTML=`
  <div class="card bg-base-100 w-96 bg-[#f3d4a8] ml-4 shadow-xl h-28 mt-4 ">
